> NOTE: These sample applications use the Programmable Voice Android SDK 2.x APIs. If you are
...
Support for 2.x will cease 1/1/2020. For examples using our 3.x APIs, please see the 
