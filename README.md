> NOTE: This sample application uses the Programmable Voice Android 3.x APIs. Support for 3.x will cease 7/1/2020. Until then, SDK 3.x will only receive fixes for critical or security related issues.
